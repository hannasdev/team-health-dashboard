...
import { SecurityEventType, SecurityEventSeverity } from '../../types/index.js';

import type { ISecurityEvent } from '../../presentation/middleware/RateLimitMiddleware/index.js';
...
describe('SecurityLogger', () => {
  ...
  describe('logSecurityEvent', () => {
    ...
    it('should log critical events as errors and trigger alert', async () => {
    ...
    it('should log low severity events as info', async () => {
