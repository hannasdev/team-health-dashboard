...
export const TYPES = {
  ...
  GitHubAdapter: Symbol.for('IGitHubAdapter'),
  ...
  GoogleSheetsAdapter: Symbol.for('IGoogleSheetsAdapter'),
  ...
  MongoAdapter: Symbol.for('IMongoAdapter<IRepository>'),
  MongoClientService: Symbol.for('MongoClientService'),
  ...
  RepositoryController: Symbol.for('IRepositoryController'),
  RepositoryManagementService: Symbol.for('IRepositoryManagementService'),
  RepositoryModel: Symbol.for('Model<IRepositoryDocument>'),
  RepositoryRepository: Symbol.for('IRepositoryRepository'),
  RepositoryRouter: Symbol.for('IRepositoryRouter'),
